    ...
    <div class="bg-stone-100 flex-grow p-4" >
        ...
        <div  class="w-[90%] bg-white m-4 " >
            <div>
                ...
                <div class="w-[80%] h-[50%]" >
                    <table class="  border-solid border-2 border-black m-10 ">
                    <thead>    
                        <tr class="table-auto border-2 border-slate-500 items-center text-[18px]">
                            <td class="w-64" > # </td>
                            <td class="w-96" > Nombre de Clase </td>
                            <td class="w-96" > Maestro </td>
                            <td class="w-64" > Calificación </td>
                            <td class="w-96" > Comentario </td>
                        </tr>
                    </thead>    
                    <tbody>
                    <?php
         ...
         <div id="myModalUpdate" class="fixed inset-0 z-50 flex items-center justify-center hidden">
                    ...
                    <div class="modal-container bg-white w-11/12 md:w-4/5 lg:w-3/4 xl:w-2/3 2xl:w-1/2 mx-auto rounded shadow-lg z-50 overflow-y-auto">
                        ...
                        <form action="/update_alumno" method="post"  class="w-[350px] flex flex-col rounded-md py-4 gap-5 bg-slate-200">
                            ...
                            <input type="text" name="nombre" class="w-[50%] " value="<?php echo $infoAlumno['nombre'] ?>">
                            </div>

                            <div class="flex gap-1 flex-row  items-center justify-between mx-10">
                            <label for="">Apellido:</label>
                            <input type="text" name="apellido" class="w-[50%] " value="<?php echo $infoAlumno['apellido'] ?>">
                            </div>
                        
                            <div class="flex gap-1 flex-row  items-center justify-between mx-10">
                            <label for="">Correo:</label>
                            <input type="text" name="correo" class="w-[50%] " value="<?php echo $infoAlumno['correo'] ?>">
                            </div>
                        

                            <div class="flex gap-1 flex-row  items-center justify-between mx-10" value="<?php echo $infoAlumno['password'] ?>">
                            ...
                            <div class="flex gap-1 flex-row  items-center justify-between mx-10">
                                ...
                                <input type="text" name="direccion" class="w-[50%]" value="<?php echo $infoAlumno['direccion'] ?>" > </input>
                            </div>
                            
                            <div class="flex gap-1 flex-row  items-center justify-between mx-10">
                                <label for="">Fecha de Nacimiento:</label>
                                <input type="date" name="fecha_nacimiento" class="w-[50%]"  value="<?php echo $infoAlumno['fecha_nacimiento'] ?>"> </input>
                            </div>
