            ...
            <div class="w-[90%] bg-white m-4 ">
                <div>
                    <div class="flex flex-row justify-between mx-5 p-3">
                        ...
                        <div class="mx-6 my-4">
                            <button type="button" id="openModal" class="bg-cyan-600  text-white px-2 rounded "> Agregar Alumno</button>
                        </div>
                    </div>
                    ...
                    <div id="myModal" class="fixed inset-0 z-50  flex items-center  justify-center hidden">
                        ...
                        <div class="modal-container bg-white w-11/12 md:w-4/5 lg:w-3/4 xl:w-2/3 2xl:w-1/2 mx-auto rounded shadow-lg z-50 overflow-y-auto">
                            <div class="modal-content py-4 text-left px-6">
                                ...
                                <form action="/create_alumno" method="post" class="w-[700px] flex flex-col rounded-md py-4 gap-5 bg-slate-200">
                                    <div class="flex gap-1 flex-row  items-center justify-between mx-10">
                                        <label for="">Matricula:</label>
                                        <input type="text" name="matricula" class="w-[80%]">
                                    </div>
                        ...
                        <table class="  border-solid border-2 border-slate-500 ">
                            <thead>
                                <tr class="table-auto border-2 border-slate-500 items-center text-[18px]">
                                    <td class="w-48"> # </td>
                                    <td class="w-64">Matricula</td>
                                    <td class="w-96"> Nombre </td>
                                    <td class="w-64"> Correo </td>
                                    <td class="w-96"> Dirección </td>
                                    <td class="w-48"> Fecha de Nacimiento </td>
                                    <td class="w-48"> Acciones </td>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                foreach ($data as $alumno) { ?>
                                    <tr>
                                        ...
                                        <td> <a href="/edit_alumno?id_alumno=<?= $alumno["id_usuario"] ?>" class="px-2 rounded "> <i class="fa-solid fa-pen-to-square mx-3" style="color: #50c9f2;"></i> </a>
                                            <a href="/borrar_alumno?id_alumno=<?= $alumno["id_usuario"] ?>"><i class="fa-solid fa-trash-can" style="color: #f22c2c;"></i></a>
                                            <!-- creas el modal con los datos del usuario -->
                                        </td>
                                    </tr>
                                <?php $contador++;
                                } ?>
...
=======
                            ...
                            <tbody>
                                ...
                                foreach ($data as $alumno) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $alumno['direccion']; ?></td>
                                        <td><?php echo $alumno['fecha_nacimiento']; ?></td>
                                        <td> <a href="/edit_alumno?id_alumno=<?= $alumno["id_usuario"] ?>" id="openModalUpdate" class="bg-cyan-600  text-white px-2 rounded "> <i class="fa-solid fa-pen-to-square" style="color: #50c9f2;"></i> </a>
                                            <a href="/borrar_alumno?id_alumno=<?= $alumno["id_usuario"] ?>"><i class="fa-solid fa-trash-can" style="color: #f22c2c;"></i></a>
                                            <!-- creas el modal con los datos del usuario -->
                                        </td>
                                    </tr>
            ...
            <!-- codigo de modal de insertar alumno -->
            <div id="myModalUpdate" class="fixed inset-0 z-50 flex items-center justify-center hidden">
                <div class="modal-overlay absolute w-full h-full bg-gray-900 opacity-50"></div>
                <div class="modal-container bg-white w-11/12 md:w-4/5 lg:w-3/4 xl:w-2/3 2xl:w-1/2 mx-auto rounded shadow-lg z-50 overflow-y-auto">
                    <div class="modal-content py-4 text-left px-6">

                        <div class="flex justify-between items-center pb-3 ">
                            <h1 class="text-3xl mb-6">Actualizar Información</h1>
                            <div id="closeModalUpdate" class="modal-close cursor-pointer z-50">
                                &times;
                            </div>
                        </div>
                        <form action="/update_alumno" method="post" class="w-[350px] flex flex-col rounded-md py-4 gap-5 bg-slate-200">
                            ...
                            <div class="flex gap-1 flex-row  items-center justify-between mx-10">
                                <label for="">Nombre:</label>
                                <input type="text" name="nombre" class="w-[80%] " value="<?php echo $infoAlumno['nombre'] ?>">
                            </div>

                            <div class="flex gap-1 flex-row  items-center justify-between mx-10">
                                <label for="">Apellido:</label>
                                <input type="text" name="apellido" class="w-[80%]" value="<?php echo $infoAlumno['apellido'] ?>">
                            </div>

                            <div class="flex gap-1 flex-row  items-center justify-between mx-10">
                                <label for="">Correo:</label>
                                <input type="text" name="correo" class="w-[80%]" value="<?php echo $infoAlumno['correo'] ?>">
                            </div>


                            <div class="flex gap-1 flex-row  items-center justify-between mx-10 w-[80%]" value="<?php echo $infoAlumno['password'] ?>">
                                <label for="">Contraseña:</label>
                            ...
                            <div class="flex gap-1 flex-row  items-center justify-between mx-10">
                                <label for="">Dirección:</label>
                                <input type="text" name="direccion" class="w-[80%]" value="<?php echo $infoAlumno['direccion'] ?>"> </input>
                            </div>

                            <div class="flex gap-1 flex-row  items-center justify-between mx-10">
                                <label for="">Fecha de Nacimiento:</label>
                                <input type="date" name="fecha_nacimiento" class="w-[80%]" value="<?php echo $infoAlumno['fecha_nacimiento'] ?>"> </input>
                            </div>
            ...
            <script>
                // Abre el modal al hacer clic en el enlace
                document.getElementById('openModalUpdate').addEventListener('click', function(e) {
                    // e.preventDefault();
                ...
                // Cierra el modal al hacer clic en la "x" o en el fondo oscuro
                document.getElementById('closeModalUpdate').addEventListener('click', function(e) {
                    e.preventDefault();
