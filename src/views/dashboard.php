    ...
    if ( $user['id_rol'] === 1 ) { ?>   
        <div>
            ...
            <div class="flex flex-col m-3 text-[12px] text-white " >
               <a href="./admin/view_permisos.php"> <i class="fa-solid fa-user-gear" style="color: #89919f;"></i>   Permisos </a> 
               <a href="./admin/view_maestros.php"> <i class="fa-solid fa-chalkboard-user" style="color: #89919f;"></i>   Maestros</a>
               <a href="./admin/view_alumnos.php">  <i class="fa-solid fa-graduation-cap" style="color: #89919f;"></i>   Alumnos </a> 
                <a href="./admin/view_materias.php"> <i class="fa-solid fa-book" style="color: #89919f;"></i>   Materias</a>
                <a href="./admin/view_clases.php"> <i class="fa-solid fa-clipboard-user" style="color: #89919f;"></i>   Clases </a>
            </div>
        </div>
