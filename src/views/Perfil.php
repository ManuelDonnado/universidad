...
>>>>>>> 01cc5dd11aa061f77f7cf6876e26fb43327ce472
                    ...
                    <?php if ($user['id_rol'] === 3) { ?>
                                    ...
                                    <div class="flex gap-1 flex-row  items-center justify-between mx-10">
                                        ...
                                        <input type="text" name="apellido" class="w-[80%]" readonly value="<?php echo $user['apellido'] ?>">
                                    </div>
                                    ...
                                    <div class="flex gap-1 flex-row  items-center justify-between mx-10">
                                        ...
                                        <input type="text" name="direccion" class="w-[80%]" readonly value="<?php echo $user['direccion'] ?>"> </input>
                                    </div>

                                    <div class="flex gap-1 flex-row  items-center justify-between mx-10">
                                        <label for="">Fecha de Nacimiento:</label>
                                        <input type="date" name="fecha_nacimiento" class="w-[80%]" readonly value="<?php echo $user['fecha_nacimiento'] ?>"> </input>
                                    </div>
